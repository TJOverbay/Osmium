...
var gulp = require('gulp'),
    ...
    lesslint = require('gulp-lesshint'),        // LESS linter (https://www.npmjs.com/package/gulp-lesshint/)
...
var sources = {
    ...
    js: [
        ...
        },
        {
            ...
            paths: paths.bower + 'bootstrap-less/js/bootstrap.min.js'
        },
        {
            name: 'jquery.js',
            copy: true,
...
gulp.task('lint-css', function () {
    return merge([                              // Combine multiple streams to one and return it so the task can be chained.
        ...
        gulp.src(lintSources.less)              // Start with the source .less files.
            .pipe(plumber())                    // Handle any errors.
            .pipe(lesslint())                   // Get and report any LESS linting errors to the console.
    ]);
});
...
gulp.task('watch-css', function () {
    return gulp
        .watch(
            paths.styles + '**/*.{css,less}',   // Watch the styles folder for file changes.
